 ...
 * @see com.leonovich.cofeebreak.dao.GenericDao
...
public interface IGenericDao<T, PK extends Serializable> {
    ...
    /**
     * Persist the given transient instance, first assigning
     * a generated identifier. (Or using the current value of
     ...
     * This operation cascades to associated instances if the
     * association is mapped with cascade="save-update"
     * @param object - a transient or detached instance
